...
function HomeBanner() {
    return (
        <div className='flex items-center rounded-[24px] py-[30px] px-[30px] flex-col lg:flex-row shadow-[0px_0px_30px_#d6d6d6] bg-[#EAF1EB] justify-around'>
            <img className='w-[50%] rounded-[24px] lg:flex hidden' src={logo} alt="" />
            <div className='flex lg:items-start items-center flex-col  m-auto lg:m-o w-[100%] lg:w-[40%] '>
                {/* <img src={logo} alt="" className='w-[100px]'/> */}
                <h1 className='text-[58px] lg:text-start text-center font-[500] mb-[10px]'>Шины</h1>
                <p className='text-[20px] lg:text-start mb-[40px] text-center'>
            ...
            <img className='lg:w-[47%] w-[60%] flex lg:hidden' src={logo} alt="" />
        </div>
    )
}
