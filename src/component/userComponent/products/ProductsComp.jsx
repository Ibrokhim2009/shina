...
function ProductsComp({ item }) {
    ...
    return (
        <div onClick={detailPageHandler} className='w-[100%] hover:shadow-[0px_0px_15px_#cdcdcd] transition-all duration-300 flex items-start pb-[20px] justify-center rounded-xl flex-col pl-[10px] bg-slate-200'>
